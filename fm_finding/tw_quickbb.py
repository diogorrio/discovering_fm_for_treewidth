...
"""
QuickBB Algorithm used for determining the exact treewidth of any given graph

Gathered from: https://github.com/cfmrp/mtool/blob/master/treewidth.py
Credit goes to @oepen
"""
...
def upper_bound(graph):
    ...
    while len(graph) > 0:
        ...
        d, u = min((count_fill_in(graph, graph[u]), u) for u in graph)
